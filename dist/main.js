...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"movingControl\": () => (/* binding */ movingControl),\n/* harmony export */   \"stopLeft\": () => (/* binding */ stopLeft),\n/* harmony export */   \"stopRight\": () => (/* binding */ stopRight)\n/* harmony export */ });\n/* harmony import */ var _sprites_moving_characters_player_player__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./sprites/moving/characters/player/player */ \"./src/utils/sprites/moving/characters/player/player.ts\");\n\r\nconst stopRight = window.innerWidth * 0.4;\r\nconst stopLeft = window.innerWidth * 0.3;\r\nconst movingControl = (game, level) => {\r\n    if (_sprites_moving_characters_player_player__WEBPACK_IMPORTED_MODULE_0__.keys.right.pressed && game.player.position.x <= stopRight) {\r\n        game.player.velocity.x = game.gameSpeed;\r\n        level.distance += game.gameSpeed;\r\n    }\r\n    else if (_sprites_moving_characters_player_player__WEBPACK_IMPORTED_MODULE_0__.keys.left.pressed && level.distance === 0) {\r\n        game.player.velocity.x = 0;\r\n        _sprites_moving_characters_player_player__WEBPACK_IMPORTED_MODULE_0__.keys.speed = 0;\r\n    }\r\n    else if (_sprites_moving_characters_player_player__WEBPACK_IMPORTED_MODULE_0__.keys.left.pressed && game.player.position.x > stopLeft) {\r\n        game.player.velocity.x = -game.gameSpeed;\r\n        level.distance -= game.gameSpeed;\r\n    }\r\n    else {\r\n        game.player.velocity.x = 0;\r\n        if (_sprites_moving_characters_player_player__WEBPACK_IMPORTED_MODULE_0__.keys.right.pressed) {\r\n            level.platforms.forEach((el) => {\r\n                el.position.x -= game.gameSpeed;\r\n            });\r\n            level.allShining.forEach((el) => {\r\n                el.position.x -= game.gameSpeed;\r\n            });\r\n            level.scrollOffset += game.gameSpeed;\r\n            level.distance += game.gameSpeed;\r\n            _sprites_moving_characters_player_player__WEBPACK_IMPORTED_MODULE_0__.keys.speed = game.gameSpeed;\r\n        }\r\n        else if (_sprites_moving_characters_player_player__WEBPACK_IMPORTED_MODULE_0__.keys.left.pressed) {\r\n            if (level.distance === 0) {\r\n                _sprites_moving_characters_player_player__WEBPACK_IMPORTED_MODULE_0__.keys.speed = 0;\r\n            }\r\n            else {\r\n                level.platforms.forEach((el) => {\r\n                    el.position.x += game.gameSpeed;\r\n                });\r\n                level.allShining.forEach((el) => {\r\n                    el.position.x += game.gameSpeed;\r\n                });\r\n                level.scrollOffset -= game.gameSpeed;\r\n                level.distance -= game.gameSpeed;\r\n                _sprites_moving_characters_player_player__WEBPACK_IMPORTED_MODULE_0__.keys.speed = -game.gameSpeed;\r\n            }\r\n        }\r\n    }\r\n    level.platforms.forEach((el) => {\r\n        if (game.player.position.y + game.player.height <= el.position.y &&\r\n            game.player.position.y + game.player.height + game.player.velocity.y >=\r\n                el.position.y &&\r\n            game.player.position.x + game.player.width >= el.position.x &&\r\n            game.player.position.x <= el.position.x + el.sizeFinal.x)\r\n            game.player.velocity.y = 0;\r\n    });\r\n    level.allShining.forEach((el) => {\r\n        if (game.player.position.y + game.player.height <= el.position.y &&\r\n            game.player.position.y + game.player.height + game.player.velocity.y >=\r\n                el.position.y &&\r\n            game.player.position.x + game.player.width >= el.position.x &&\r\n            game.player.position.x <= el.position.x + el.sizeFinal.x)\r\n            game.player.velocity.y = 0;\r\n    });\r\n};\r\n\n\n//# sourceURL=webpack://platformer-2d/./src/utils/moving-control.ts?");
