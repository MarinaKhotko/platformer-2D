...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"Enemy\": () => (/* binding */ Enemy),\n/* harmony export */   \"GroundEnemy\": () => (/* binding */ GroundEnemy),\n/* harmony export */   \"groundEnemy\": () => (/* binding */ groundEnemy),\n/* harmony export */   \"hedgehogArg\": () => (/* binding */ hedgehogArg),\n/* harmony export */   \"player\": () => (/* binding */ player)\n/* harmony export */ });\n/* harmony import */ var _utils_character__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/character */ \"./src/utils/character.ts\");\n\r\nclass Enemy extends _utils_character__WEBPACK_IMPORTED_MODULE_0__.PrototypeCharacters {\r\n    constructor(position, sizeFinal, spriteSize, path, frames, maxFrame, velocityX, velocityY, distanceMovingMin, distanceMovingMax) {\r\n        super(position, sizeFinal, spriteSize, path, frames, velocityX, velocityY);\r\n        this.fps = 30;\r\n        this.frameTimer = 0;\r\n        this.frameInterval = 1000 / this.fps;\r\n        this.currantFrame = 1;\r\n        this.maxFrame = maxFrame;\r\n        this.distanceMovingMin = distanceMovingMin;\r\n        this.distanceMovingMax = distanceMovingMax;\r\n    }\r\n    update(deltaTime) {\r\n        if (this.frameTimer > this.frameInterval) {\r\n            this.frameTimer = 0;\r\n            this.frames.x < this.maxFrame ? this.frames.x++ : (this.frames.x = 0);\r\n        }\r\n        else\r\n            this.frameTimer += deltaTime;\r\n    }\r\n}\r\nclass GroundEnemy extends Enemy {\r\n    update(deltaTime) {\r\n        super.update(deltaTime);\r\n        if (this.position.x === this.distanceMovingMin) {\r\n            this.velocityX = Math.abs(this.velocityX);\r\n            this.frames.y = 1;\r\n        }\r\n        if (this.position.x === this.distanceMovingMax) {\r\n            this.velocityX = -Math.abs(this.velocityX);\r\n            this.frames.y = 2;\r\n        }\r\n        this.position.x += this.velocityX;\r\n        this.draw();\r\n    }\r\n}\r\nconst hedgehogArg = [\r\n    { x: 1500, y: 60 },\r\n    { x: 169, y: 122 },\r\n    { x: 169, y: 122 },\r\n    '../../assets/hedgehog.png',\r\n    { x: 0, y: 1 },\r\n    13,\r\n    -5,\r\n    0,\r\n    300,\r\n    1500,\r\n];\r\nconst groundEnemy = new GroundEnemy(...hedgehogArg);\r\n// export class FlyingEnemy extends Enemy {\r\n//   update(deltaTime: number): void {\r\n//     super.update(deltaTime);\r\n//     this.position.x += this.velocityX;\r\n//     this.draw();\r\n//   }\r\n// }\r\n// export class Crow extends FlyingEnemy {\r\n//   constructor(\r\n//     position = {\r\n//       x: window.innerWidth,\r\n//       y: Math.random() * game.canvas.height * 0.4,\r\n//     },\r\n//     sizeFinal = { x: 160, y: 200 },\r\n//     spriteSize = { x: 160, y: 200 },\r\n//     path = '../../assets/crow.png',\r\n//     maxFrame = 15,\r\n//     velocityX = Math.random() + 3,\r\n//     velocityY = 0,\r\n//   ) {\r\n//     super(\r\n//       position,\r\n//       sizeFinal,\r\n//       spriteSize,\r\n//       path,\r\n//       maxFrame,\r\n//       velocityX,\r\n//       velocityY,\r\n//     );\r\n//   }\r\n// }\r\nconst player = new _utils_character__WEBPACK_IMPORTED_MODULE_0__.Player({ x: 0, y: 500 }, { x: 210.5, y: 200 }, { x: 150, y: 200 }, '../../assets/player.png', { x: 0, y: 0 }, 5, 0);\r\n\n\n//# sourceURL=webpack://platformer-2d/./src/components/enemies.ts?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ Game),\n/* harmony export */   \"game\": () => (/* binding */ game)\n/* harmony export */ });\n/* harmony import */ var _enemies__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./enemies */ \"./src/components/enemies.ts\");\n\r\nclass Game {\r\n    constructor() {\r\n        this.canvas = document.querySelector('canvas');\r\n        this.ctx = this.canvas.getContext('2d');\r\n        this.canvas.width = window.innerWidth;\r\n        this.canvas.height = window.innerHeight;\r\n        window.addEventListener('resize', () => {\r\n            this.canvas.width = window.innerWidth;\r\n            this.canvas.height = window.innerHeight;\r\n        });\r\n    }\r\n    update(deltaTime) {\r\n        this.ctx.fillStyle = 'gray';\r\n        this.ctx.fillRect(0, 0, this.canvas.width, this.canvas.height);\r\n        _enemies__WEBPACK_IMPORTED_MODULE_0__.player.update();\r\n        _enemies__WEBPACK_IMPORTED_MODULE_0__.groundEnemy.update(5);\r\n    }\r\n}\r\nconst game = new Game();\r\n\n\n//# sourceURL=webpack://platformer-2d/./src/components/game-canvas.ts?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_sass__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.sass */ \"./src/style.sass\");\n/* harmony import */ var _components_game_canvas__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/game-canvas */ \"./src/components/game-canvas.ts\");\n\r\n\r\nconst game = new _components_game_canvas__WEBPACK_IMPORTED_MODULE_1__[\"default\"]();\r\nconst loop = () => {\r\n    requestAnimationFrame(loop);\r\n    game.update(30);\r\n};\r\nrequestAnimationFrame(loop);\r\n\n\n//# sourceURL=webpack://platformer-2d/./src/index.ts?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"Player\": () => (/* binding */ Player),\n/* harmony export */   \"PrototypeCharacters\": () => (/* binding */ PrototypeCharacters)\n/* harmony export */ });\n/* harmony import */ var _components_game_canvas__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/game-canvas */ \"./src/components/game-canvas.ts\");\n\r\nclass PrototypeCharacters {\r\n    constructor(position, sizeFinal, spriteSize, path, frames, velocityX, velocityY) {\r\n        this.characterImg = new Image();\r\n        this.frames = { x: 0, y: 0 };\r\n        this.position = position;\r\n        this.sizeFinal = sizeFinal;\r\n        this.spriteSize = spriteSize;\r\n        this.ImgPath = path;\r\n        this.characterImg.src = this.ImgPath;\r\n        this.frames = frames;\r\n        this.velocityX = velocityX;\r\n        this.velocityY = velocityY;\r\n    }\r\n    draw() {\r\n        _components_game_canvas__WEBPACK_IMPORTED_MODULE_0__.game.ctx.drawImage(this.characterImg, this.spriteSize.x * this.frames.x, this.spriteSize.y * this.frames.y, this.spriteSize.x, this.spriteSize.y, this.position.x, this.position.y, this.sizeFinal.x, this.sizeFinal.y);\r\n    }\r\n}\r\nclass Player extends PrototypeCharacters {\r\n    update() {\r\n        this.position.x += this.velocityX;\r\n        this.draw();\r\n    }\r\n}\r\n\n\n//# sourceURL=webpack://platformer-2d/./src/utils/character.ts?");
